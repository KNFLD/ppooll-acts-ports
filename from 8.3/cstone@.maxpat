...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 0.0, 37.0, 19.0 ],
					"text" : "sync",
					"texton" : "sync",
					"varname" : "syncz"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 76.0, 0.0, 47.0, 19.0 ],
					"varname" : "default"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 82.0, 522.0, 51.0, 22.0 ],
									"text" : "ll.r~ in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 20.0, 642.0, 130.0, 22.0 ],
									"text" : "record~ #0_fred10 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 11.5, 331.0, 41.0, 22.0 ],
									"text" : "ll.r left"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 474.666687000000024, 169.0, 81.0, 22.0 ],
									"text" : "ll.r RateCalc2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 756.666687000000024, 380.0, 89.0, 22.0 ],
									"text" : "ll.s NumRows2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 864.0, 719.0, 83.0, 22.0 ],
									"text" : "ll.s RateCalc2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 832.888855000000035, 578.0, 87.0, 22.0 ],
									"text" : "ll.r NumRows2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 897.888855000000035, 621.0, 104.0, 22.0 ],
									"text" : "ll.r Phasor_Speed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.333312999999997, 169.0, 81.0, 22.0 ],
									"text" : "ll.r RateCalc1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 596.111144999999965, 719.0, 83.0, 22.0 ],
									"text" : "ll.s RateCalc1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 163.75, 155.5, 106.0, 22.0 ],
									"text" : "ll.s Phasor_Speed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 622.0, 578.0, 87.0, 22.0 ],
									"text" : "ll.r NumRows1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 318.0, 305.0, 89.0, 22.0 ],
									"text" : "ll.s NumRows1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 687.0, 621.0, 104.0, 22.0 ],
									"text" : "ll.r Phasor_Speed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 364.0, 22.0, 60.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 457.666687000000024, 409.0, 184.0, 22.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ 502.666687000000024, 235.0, 165.0, 35.0 ],
									"text" : "2d.wave~ #0_fred10 0. 0. 1 16"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 774.25, 146.0, 157.0, 22.0 ],
									"text" : "buffer~ #0_fred10 4000 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 20.0, 409.0, 184.0, 22.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 193.0, 160.0, 12.0 ],
					"varname" : "ll.inputmix",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 0.0, 71.0, 16.0 ],
					"varname" : "title_LCD"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"preset-ramp" : [ 0.0 ],
						"presets" : [ 0 ],
						"rate1" : [ 0.435897435897436 ],
						"rate2" : [ 0.205128205128205 ],
						"right" : [ -6.125 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.5, 0.0, 35.5, 22.0 ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 0.0, 35.5, 14.0 ],
					"varname" : "master"
				}
